path_params = {
    ...
    "force_skel": "/uge_mount/FORCE/new_struc/scripts_sits/sits_change_harmonic/force/skel/force_cube_sceleton",
    "scripts_skel": "/uge_mount/FORCE/new_struc/scripts_sits/sits_change_harmonic/force/skel",
