...
params = {
    ...
    #########Basics##########
    #########################
    "project_name": "test_full_tile_all_time", #Project Name that will be the name of output folder in temp & result subfolder test_full_tile_all_time
    ...
    "TSS_DATE_RANGE": "2018-06-01 2025-07-16",# TimeRange for ChangeDetection. Will also be Prediction Time Range for TSI 2018-06-01 2025-07-16
    ...
    "start_date": "2024-06", # Starting Date for Period Calculation 2018-06
    "end_date": "2024-08", # End Date for Period Calculation  2025-07
