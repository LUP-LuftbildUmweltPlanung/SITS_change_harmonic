...
params = {
    ...
    #########Basics##########
    #########################
    "project_name": "test_dates", #Project Name that will be the name of output folder in temp & result subfolder test_full_tile_all_time
    "aoi": "/uge_mount/Freddy/harmonic_model/data/positive_disturbence/mini_aoi_neg.shp", #Define Area of Interest as Shapefile
    ...
    "TSS_DATE_RANGE": "2018-06-01 2025-07-21",# TimeRange for ChangeDetection. Will also be Prediction Time Range for TSI 2018-06-01 2025-07-16
    ...
    "end_date": "2025-07", # End Date for Period Calculation  2025-07
