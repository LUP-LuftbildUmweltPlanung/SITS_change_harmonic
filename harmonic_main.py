...
params = {
    ...
    #########Basics##########
    #########################
    "project_name": "pos2", #Project Name that will be the name of output folder in temp & result subfolder
    "aoi": "/uge_mount/Freddy/harmonic_model/data/mini_aoi_pos.shp", #Define Area of Interest as Shapefile
    ...
    "TSS_DATE_RANGE": "2024-01-01 2024-12-31",# TimeRange for ChangeDetection. Will also be Prediction Time Range for TSI
    ...
    "start_date": "2024-01", # Starting Date for Period Calculation
    "end_date": "2024-12", # End Date for Period Calculation
    "period_length": 6, # # Time Range for Period Calculation
    }
